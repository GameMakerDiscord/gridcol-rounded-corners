///@function sr_drawlist_push_rectangle(_x1, _y1, _x2, _y2, [_bordered=true], [_color=c_white], [_alpha=1])
...
_elem[@ ERousrDrawlist_Element.Bordered] = (argument_count > 4) ? argument[4] : true;
_elem[@ ERousrDrawlist_Element.Colour] = (argument_count > 5) ? argument[5] : c_white;
_elem[@ ERousrDrawlist_Element.Alpha] = (argument_count > 6) ? argument[6] : 1;
